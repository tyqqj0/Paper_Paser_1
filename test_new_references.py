        ...
        if response.status_code == 200:
            ...
            if refs:
                ...
                if parsed_count > 0:
                    ...
                    print(f"  有标题: {title_count}/{parsed_count} ({title_count/parsed_count*100:.1f}%)")
                    print(f"  有年份: {year_count}/{parsed_count} ({year_count/parsed_count*100:.1f}%)")
                    print(f"  有作者: {author_count}/{parsed_count} ({author_count/parsed_count*100:.1f}%)")
