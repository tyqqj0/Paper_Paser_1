...
This module provides the Neo4j equivalent of the MongoDB alias system,
...
class Neo4jAliasDAO:
    ...
    @classmethod
    def create_from_global_connection(cls) -> "Neo4jAliasDAO":
        """Create DAO instance using global Neo4j connection."""
        return cls()
    
    @classmethod
    def create_from_task_driver(cls, driver: AsyncDriver) -> "Neo4jAliasDAO":
        """
    ...
    async def get_statistics(self) -> Dict[str, Any]:
        ...
        try:
            async with await self._get_session() as session:
                ...
                total_query = """
                MATCH (alias:Alias)
                RETURN count(alias) as total_count
                """
